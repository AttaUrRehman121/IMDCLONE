        ...
        <div className="grid md:grid-cols-2 gap-4 sm:gap-6 mb-8">
          ...
          <div className="bg-gray-800 rounded-2xl p-6 sm:p-8 text-white">
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Gain Access to all USMLE resources our platform provides from lectures to QBanks and self Assessments in single subscription.
            </p>
            <div className="bg-gray-700 rounded-xl p-4 aspect-video flex items-center justify-center">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-400">USMLE Resources</p>
              </div>
            </div>
          </div>
